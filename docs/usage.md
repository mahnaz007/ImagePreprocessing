...
**Note**: For a visual understanding of how the processes in this pipeline are connected, you can refer to the [IRTG MRI Data Preprocessing](https://github.com/mahnaz007/ImagePreprocessing/blob/main/docs/IRTG%20MRI%20Data%20Preprocessing.jpg) on GitHub. This image provides a general overview of the entire workflow, helping to clarify how the different steps interact with each other.
