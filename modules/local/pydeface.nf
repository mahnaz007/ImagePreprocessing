...
// Define the input and output directories and the Singularity image path as parameters
params.inputDir = params.inputDir ?: 'path/to/input'
params.defacedOutputDir = params.defacedOutputDir ?: 'path/to/output/defaced'
params.singularityImg = params.singularityImg ?: 'path/to/pydeface_latest.sif'
